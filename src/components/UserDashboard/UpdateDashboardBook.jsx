...
const UpdateDashboardBook = () => {
    const handleUpdateddBook = (e) => {
        e.preventDefault();
    }
    return (

        <div className="dark:text-white">
            <h3 className="text-center dark:text-white py-8 text-3xl font-bold">Update Your<span className='text-purple-500 font-bold'> Book</span>.... <span className="text-4xl font-bold text-purple-500">!</span></h3>
            <div className="pt-5">
                <div className="lg:w-1/2 w-full mx-auto shadow-lg dark:bg-zinc-800 bg-blue-50 dark:text-white dark:border">
                    <form onSubmit={handleUpdateddBook} className="card-body dark:text-white">
...
export default UpdateDashboardBook;