    ...
    return (
        <div className="my-12 container mx-auto dark:text-white">
            ...
            <Marquee speed={100} pauseOnHover={true} className="w-[100%]">
               ...
               <div className="w-[300px] lg:w-[450px] flex flex-col items-center justify-center cursor-pointer border px-5 py-8  space-y-3 mr-8 ">
                    <div className="w-[140px] h-[140px] lg:w-[200px] lg:h-[200px] rounded-full border-2 border-white">
